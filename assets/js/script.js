...
const districtData = {
    somayampalayam: {
        eyebrow: "Palm Seed Plantation",
        title: "Somayampalayam, Coimbatore",
        copy: "Aaniver Organization successfully planted 5,000 palm seeds along the water channels of Somayampalayam over five weeks to restore groundwater recharge and strengthen the local ecosystem.",
        projects: "5,000",
        focus: "Palm Seeds",
        reach: "Oct 2025"
    },
    ...
    kalappanaickenpalayam: {
        eyebrow: "Lake Cleanup Drive",
        title: "Kalappanaickenpalayam, Coimbatore",
        copy: "Volunteers removed more than 2 tonnes of plastic waste, bottles, cloth, footwear and other garbage from the Kalappanaickenpalayam pond, restoring the waterbody and improving environmental health.",
        projects: "2+ Tons",
        focus: "Plastic Cleanup",
        reach: "Jul 2025"
    },

    maruthamalai: {
        eyebrow: "Temple Cleanup",
        title: "Maruthamalai, Coimbatore",
        copy: "More than 80 volunteers from Aaniver Organization and Vellingiri Hills Protection Organization carried out a large-scale cleanliness drive along the Maruthamalai Murugan Temple steps and roadside.",
        projects: "80+",
        focus: "Volunteers",
        reach: "Jun 2026"
    }
